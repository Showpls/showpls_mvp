...
//     // Require connected wallet before proceeding
//     if (!wallet) {
...
//                 <AlertDialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-sm rounded-lg bg-card border border-brand-primary/30 p-4 shadow-xl z-[101]">
